...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/org/dav/alurahotel/imagenes/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/org/dav/alurahotel/imagenes/lOGO-50PX.png")));
